...
- **HITL \+ AI Feedback Pipeline**: Every human adjudication creates a structured feedback log (category, detail, divergence type) that feeds the AI retraining pipeline.
