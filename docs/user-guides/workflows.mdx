...
ProcureCheck runs against the applicant. If procurement fails to execute (for example API auth/provider errors), the workflow records a manual-required procurement status and continues with the remaining Stage 3 checks.
