...
ALTER TABLE `activity_logs` ALTER COLUMN "created_at" TO "created_at" integer DEFAULT '"2026-03-12T04:22:09.660Z"';--> statement-breakpoint
...
ALTER TABLE `risk_assessments` ALTER COLUMN "created_at" TO "created_at" integer DEFAULT '"2026-03-12T04:22:09.659Z"';--> statement-breakpoint
ALTER TABLE `workflows` ADD `green_lane_approval` text;