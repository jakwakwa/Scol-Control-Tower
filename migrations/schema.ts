...
export const agents = sqliteTable("agents", {
	...
	lastCallbackAt: integer("last_callback_at"),
	callbackCount: integer("callback_count").default(0).notNull(),
	errorCount: integer("error_count").default(0).notNull(),
	createdAt: integer("created_at").notNull(),
},
(table) => [
	uniqueIndex("agents_agent_id_unique").on(table.agentId),
]);
...
export const aiFeedbackLogs = sqliteTable("ai_feedback_logs", {
	...
	overrideDetails: text("override_details"),
