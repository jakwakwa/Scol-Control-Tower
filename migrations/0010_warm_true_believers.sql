...
ALTER TABLE `activity_logs` ALTER COLUMN "created_at" TO "created_at" integer DEFAULT '"2026-03-24T19:10:50.953Z"';--> statement-breakpoint
...
ALTER TABLE `risk_assessments` ALTER COLUMN "created_at" TO "created_at" integer DEFAULT '"2026-03-24T19:10:50.947Z"';--> statement-breakpoint
ALTER TABLE `applicants` ADD `vat_number` text;