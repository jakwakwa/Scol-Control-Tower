...
export const ApplicantReminder = ({
	contactName,
	itemName,
	actionUrl,
	reminderNumber,
		...
		<EmailLayout preview={`Reminder: Your ${itemName} is awaiting completion`}>
			<Section>
				...
				<Text className="text-black text-[14px] leading-[24px]">
					...
					<strong>{itemName}</strong> is still outstanding. Please
					complete it at your earliest convenience to avoid delays in
					your onboarding process.
				</Text>
				{isLast && (
					<Text className="text-[#b91c1c] text-[14px] leading-[24px] font-semibold">
						This is your final reminder. If we do not receive a
						response soon, your application may be closed.
					</Text>
				)}
				{actionUrl && (
				...
				<Text className="text-[#666666] text-[12px] leading-[20px]">
					Reminder {reminderNumber} of {maxReminders}. If you have
					already completed this, please disregard this email.
				</Text>
			</Section>
		</EmailLayout>
	);
...
export default ApplicantReminder;
